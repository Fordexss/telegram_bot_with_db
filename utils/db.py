...
class BotDB:
    ...
    def update_user_info(self, user_id, new_first_name, new_last_name):
        self.cursor.execute("""
            UPDATE users
        ...
        if self.cursor.rowcount > 0:
            return f"Інформацію про користувача (ID: {user_id}) успішно оновлено."
        else:
            return f"Користувача з ID {user_id} не знайдено, оновлення не виконано."
